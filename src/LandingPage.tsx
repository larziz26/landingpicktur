  ...
  fr: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Si j'arrête Picktur, je perds mes photos ?", a: "Point important : Picktur n'est pas un outil de stockage cloud. Vos photos ne vivent pas chez nous — elles vivent sur votre propre infrastructure de stockage. Si vous arrêtez votre abonnement, votre accès et vos galeries partagées sont coupés, mais vos fichiers restent intacts là où ils ont toujours été. Comme toujours en photo : gardez vos backups, sur vos disques externes ou vos cartes SD. Picktur est l'interface qui les rend intelligents et partageables — pas leur maison." },
  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "If I stop using Picktur, do I lose my photos?", a: "Important clarification: Picktur is not a cloud storage tool. Your photos don't live with us — they live on your own storage infrastructure. If you cancel your subscription, your access and shared galleries are cut off, but your files remain intact where they've always been. As always in photography: keep your backups, on external drives or memory cards. Picktur is the interface that makes them smart and shareable — not their home." },
