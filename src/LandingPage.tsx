  ...
  fr: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Si j'arrête Picktur, je perds mes photos ?", a: "Non. Vos photos restent sur votre propre serveur de stockage — Picktur n'est que l'interface intelligente par-dessus. Si vous partez, vos photos restent intactes, exactement là où elles ont toujours été." },
  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "If I stop using Picktur, do I lose my photos?", a: "No. Your photos stay on your own storage server — Picktur is just the smart interface on top. If you leave, your photos remain exactly where they've always been." },
