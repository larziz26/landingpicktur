  ...
  fr: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Mes clients utilisent déjà WeTransfer ou Dropbox. Pourquoi changeraient-ils ?", a: "Picktur n'est pas un service de partage de fichiers. C'est une expérience : galerie à votre image, selfie pour retrouver ses photos, sélection guidée pour l'album. Vos clients ne veulent pas télécharger un ZIP — ils veulent revivre le moment." },
        { q: "La reconnaissance faciale fonctionne en basse lumière ou en soirée ?", a: "Oui. Picktur utilise la reconnaissance faciale d'Immich, entraînée sur des photos réelles dans des conditions variées — salle de réception, lumière tamisée, contre-jour. Elle fonctionne là où vous travaillez vraiment." },
        { q: "Si j'arrête Picktur, je perds mes photos ?", a: "Non. Vos photos restent sur votre serveur Immich — Picktur n'est que l'interface intelligente par-dessus. Si vous partez, vos photos restent intactes, exactement là où elles ont toujours été." },
        { q: "Ça vaut le coût si j'utilise déjà Lightroom ?", a: "Lightroom vous aide à retoucher. Picktur vous aide à trier avant, livrer après et créer l'expérience client — ce sont des outils complémentaires. Mais si vous comptez les heures passées à trier manuellement avant même d'ouvrir Lightroom, la comparaison est rapide." },
        { q: "Les galeries sont disponibles combien de temps pour mes clients ?", a: "Les galeries sont accessibles pendant 1 an à partir de la livraison. Vos clients peuvent consulter et télécharger leurs photos en HD à tout moment pendant cette période." },
      ],
    },
    finalCta: {
  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "My clients already use WeTransfer or Dropbox. Why would they switch?", a: "Picktur isn't a file-sharing service. It's an experience: a gallery in your brand, a selfie to find your photos, guided selection for the album. Your clients don't want to download a ZIP — they want to relive the moment." },
        { q: "Does face recognition work in low light or evening settings?", a: "Yes. Picktur uses Immich's face recognition, trained on real photos in varied conditions — reception halls, dim lighting, backlighting. It works where you actually shoot." },
        { q: "If I stop using Picktur, do I lose my photos?", a: "No. Your photos stay on your Immich server — Picktur is just the smart interface on top. If you leave, your photos remain exactly where they've always been." },
        { q: "Is it worth the cost if I already use Lightroom?", a: "Lightroom helps you retouch. Picktur helps you sort before and deliver after — they're complementary. But if you count the hours spent manually culling before even opening Lightroom, the comparison speaks for itself." },
